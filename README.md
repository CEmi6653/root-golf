...
## 今後実装したい機能
複数の写真の投稿機能
複数画像を保存でき、保存した画像を詳細ページに載せれるようする目的。

マップ機能と動画機能
GoogleマップやYouTubeの情報を詳細ページに載せれるようにする目的。

管理者のマイページにコメント履歴が確認できるようにする目的。
...
# 使用技術
HTML/CSS/jquery/javascript/ruby_on_rails
github,S3,heroku,EC2
