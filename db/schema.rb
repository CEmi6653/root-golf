...
ActiveRecord::Schema.define(version: 2021_08_17_062201) do
  ...
  create_table "golfs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_golfs_on_user_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "play_histry_id", null: false
    t.integer "bith_place_id", null: false
